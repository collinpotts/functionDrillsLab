...
console.log(exclaimThree('Collin'));
...
//CODE HERE
console.log('=================');
const theEliminator = (contestantsArr, loserVar) => {
  for(let i = 0; i < contestantsArr.length; i++) {
    if(contestantsArr[i].toLowerCase() === loserVar.toLowerCase()){
...
console.log(emailCheck('c m adiwfij@gmail.com'));
////////////////// PROBLEM 19 ////////////////////
/*
...
//CODE HERE
console.log('=================');
const frogBuyer2 = gld => {
  if(!(gld % 3 === 0)){
    gld -= 1;
  }
  return gld / 3;
}
let totalFrogs2 = frogBuyer2(40);
console.log(totalFrogs2);


////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,1,2,4,3,5,6,7,8,9]
/*
...
let arrayIsAscending = arrayIsAscendingFunction(sampleArray);
